                 ...
                 if(line.matches("[a-zA-Z'@ ]*, [a-zA-Z]{2}( .*|[.])?")) {
                     ...
                     if(!(previousLine.contains("suite") || previousLine.contains("floor") || line.contains("suite")
                         ...
                         if(line.length() < 35) {
                             ...
                             ParallelScrape.address.offer(entry);
                         }
                     }
                 ...
                 while(ws.hasMoreTokens()) {
                     ...
                     try {
                         ...
                         if(token.toLowerCase().equals("lease") || token.toLowerCase().equals("leased")) {
                             ...
                             ParallelScrape.term.offer(entry);
                             ...
                             ParallelScrape.emails.offer(entry);
                             ...
                             if(lastToken.matches("[,±0-9/+//-]{3,}")) {
                                 Entry entry = new Entry(threadPageNumber, lastToken.replace("±", "").replace("+/-", ""));
                                 ParallelScrape.squareFootage.offer(entry);
                             }
                             ...
                             ParallelScrape.phoneNumbers.offer(entry);
